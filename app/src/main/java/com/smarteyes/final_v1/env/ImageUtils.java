package com.smarteyes.final_v1.env;
...
public class ImageUtils {
  ...
  public static void convertARGB8888ToYUV420SP1(
  ...
  public static void convertRGB565ToYUV420SP1(byte[] input, byte[] output, int width, int height){
    try {
      //LOGGER.e("aaaaaaaaaaaaaaaaaaaaaa");
      ImageUtils.convertRGB565ToYUV420SP(input,output,width,height);
      return;
    } catch (UnsatisfiedLinkError e) {
      LOGGER.e(
              "Native RGB565 -> 420sp implementation not found");
    }
  }

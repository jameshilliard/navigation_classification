...
import com.smarteyes.final_v1.env.SplitTimer;


  public class YOLO implements Classifier {
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    //LOGGER.i("len of intVaules: %d",intValues.length);
    //LOGGER.e("size of bmp: %d   %d",bitmap.getWidth(),bitmap.getHeight());
    ...
    //LOGGER.e("abc : %f    %f    %f    %f",floatValues[0],floatValues[1],floatValues[2],floatValues[3]);
    ...
    for (int y = 0; y < gridHeight; ++y) {
      for (int x = 0; x < gridWidth; ++x) {
        for (int b = 0; b < NUM_BOXES_PER_BLOCK; ++b) {
          ...
          LOGGER.i("%f :: %f :: %f :: %d",maxClass,confidence,maxClass * confidence,detectedClass);
